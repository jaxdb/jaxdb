...
&ensp;&ensp;&ensp;&ensp;<samp>{ { LEFT \| RIGHT \|</samp>                                                                               | [:white_check_mark:][JoinedTableTest]                   | [:white_check_mark:][JoinedTableTest]                   | [:white_check_mark:][JoinedTableTest]                   |
&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;<samp>FULL }</samp>                                                                     | [:large_blue_circle:][JoinedTableTest]                  | [:large_blue_circle:][JoinedTableTest]                  | [:white_check_mark:][JoinedTableTest]                   |
...
&ensp;&ensp;<samp>LOG(b, x) \|</samp>                                                                                                   | [:white_check_mark:][NumericFunctionTest]               | [:white_check_mark:][NumericFunctionTest]               | [:white_check_mark:][NumericFunctionTest]               |
...
**<samp><a name="numeric_combination_cast">&lt;numeric combination cast&gt;</a>** ::=&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;</samp> | [:white_check_mark:][NumericValueExpressionTest]        | [:white_check_mark:][NumericValueExpressionTest]        | [:white_check_mark:][NumericValueExpressionTest]        |
                           ...
                           | **<samp>FLOAT</samp>** | **<samp>DOUBLE</samp>** | **<samp>DECIMAL</samp>** | **<samp>TINYINT</samp>** | **<samp>SMALLINT</samp>** | **<samp>INT</samp>** | **<samp>BIGINT</samp>** |
--------------------------:|------------------------|-------------------------|--------------------------|--------------------------|---------------------------|----------------------|-------------------------|
