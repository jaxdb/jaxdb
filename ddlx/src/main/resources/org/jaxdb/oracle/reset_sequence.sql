...
BEGIN
  ...
  EXCEPTION WHEN sequence_does_not_exist THEN RETURN 0;
...
-- CREATE SEQUENCE "sq_type_id" INCREMENT BY 1 START WITH 1001 MAXVALUE 1000000 MINVALUE 1 CYCLE CACHE 1000000 NOORDER;

-- SELECT * FROM all_sequences WHERE sequence_name = 'sq_type_id';

-- EXEC DBMS_OUTPUT.PUT_LINE(reset_sequence('sq_type_id', 1000));
-- SELECT MIN("id"), MAX("id") FROM "type";
